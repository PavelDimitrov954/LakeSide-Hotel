...
import com.javaholics.lakesidehotel.exceptions.PhotoRetrievalException;
...
import com.javaholics.lakesidehotel.service.BookedRoomService;
...
public class RoomController {
    ...
    private RoomResponse getRoomResponse(Room room) {
        List<BookingResponse> bookingInfo = getBookingResponsesForRoom(room.getId());
        byte[] photoBytes = retrievePhotoBytes(room.getPhoto());
    ...
    private List<BookingResponse> getBookingResponsesForRoom(Long roomId) {
    ...
    private byte[] retrievePhotoBytes(Blob photoBlob) {
        if (photoBlob == null) {
            return null;
        }
        try {
